...
class StatsPageViewController: UIPageViewController, UIPageViewControllerDelegate, UIPageViewControllerDataSource {
    ...
    lazy var orderedViewControllers: [UIViewController] = {
        return [self.newVc(viewController: "MonthGraph"),
                self.newVc(viewController: "DurationGraph"),
                self.newVc(viewController: "StartTimeGraph"),
                self.newVc(viewController: "LocationMap")]
    }()
